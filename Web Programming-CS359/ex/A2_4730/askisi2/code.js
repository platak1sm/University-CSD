...
// xhr.setRequestHeader("X-RapidAPI-Key", "3bbe3ba6e0mshe08c5f83ae45db6p19a483jsn6a45dc8cfe23");
...
function loadDoc() {
    ...
    var form = documents.form.myForm;
    var addressName = form.adst.value;
    var number = form.adnum.value;
    var city = form.city.value;
    var country = document.querySelector("#country").text;
    var address = addressName + " " + number + " " + city + " " + country;
    xhr.open("GET", "https://forward-reverse-geocoding.p.rapidapi.com/v1/search?q=" + address + "&accept-language=en&polygon_threshold=0.0");
    xhr.setRequestHeader("x-rapidapi-host", "forward-reverse-geocoding.p.rapidapi.com");
    xhr.setRequestHeader("x-rapidapi-key", "3bbe3ba6e0mshe08c5f83ae45db6p19a483jsn6a45dc8cfe2");
    xhr.send(data);
}
...
function typeofperson() {
    ...
    if (val[0].checked) {
        ...
        document.getElementById("uni-in-crete").required = true;
        ...
        document.getElementById("uni-in-crete").required = false;
...
function check() {
    ...
    var str = '';
    if (document.querySelector("#uni-in-crete").value === "UOC") {
    ...
    } else if (document.querySelector("#uni-in-crete").value === "HELMEPA") {
    ...
    } else if (document.querySelector("#uni-in-crete").value === "TUC") {
        for (var i = length - 6; i < length; i++) {
            str += email[i];
        }
    ...
    var val = document.getElementsByName("SRole");
